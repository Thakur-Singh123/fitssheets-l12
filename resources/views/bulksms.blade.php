...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">SMS Alerts</h4>
                    <form method="POST" action="{{ url('/smsnotification') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                style="font-size: 16px; width: 50px; height: 25px"
                                type="checkbox"
                                value="1"
                                name="all_user"
                                id="all_userb"
                        ...
                        <div id="all_u_c" class="form-group">
                            ...
                            <select name="users_id[]" id="users_idm" class="mySelect" multiple="multiple">
                                ...
                                @if($user->count() != 0) @foreach ($user as $users)
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="numbers" placeholder="e.g. 9876543213" />
                        </div>
