        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/admin/update-profile') }}" enctype="multipart/form-data" class="forms-sample">
                        @csrf
                        <input type="hidden" id="user_id" name="user_id" class="form-control" value="{{ Auth::user()->id }}" >
                        <div class="form-group text-center mb-4">
                            <div class="profile-upload-wrapper">
                                @if(!empty(Auth::user()->avtar))
                                    <img src="{{ asset('public/assets/uploads/admin/'.Auth::user()->avtar) }}" class="profile-preview">
                                @else
