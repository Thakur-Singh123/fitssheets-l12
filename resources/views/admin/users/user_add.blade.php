						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="hours_day" name="hours_day" value="{{ old('hours_day') }}" placeholder="2026-08-20"> 
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group"> 
							...
							<?php if($u_role != "supervisor"){ ?> 
								...
								<div class="col-md-6">
									<div class="form-group"> 
										...
										<input type="text" class="form-control" id="ssn_no" name="ssn_no" value="{{ old('ssn_no') }}" placeholder="SSN No"> 
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group"> 
										<label for="email">Child Sup</label> 
										<input type="text" class="form-control" id="child_sup" name="child_sup" value="{{ old('child_sup') }}" placeholder="$100"> 
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group"> 
										<label for="email">Health Insurance</label> 
										<input type="text" class="form-control" id="health_insurance" name="health_insurance" value="{{ old('health_insurance') }}" placeholder="$100"> 
									</div>
								</div>
							<?php } ?> 
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="position-relative">
										...
										<span class="password-toggle" data-target="confirmed">
											<i class="fa fa-eye"></i>
										</span>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="hour_rate" name="hour_rate" value="{{ old('hour_rate') }}" placeholder="Hourly Rate"> 
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group"> 
