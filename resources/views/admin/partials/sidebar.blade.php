<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item {{ $adminReportsActive ? 'active' : '' }}">
      <a class="nav-link" data-toggle="collapse" href="#ui-areports" aria-expanded="{{ $adminReportsActive ? 'true' : 'false' }}" aria-controls="ui-areports">
      ...
      <div class="collapse {{ $adminReportsActive ? 'show' : '' }}" id="ui-areports">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('all/users/vaccine/report') ? 'active-submenu' : '' }}" href="{{ url('/all/users/vaccine/report') }}">
              Users Vaccine Reports
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('all/applicants/view') ? 'active-submenu' : '' }}" href="{{ url('/all/applicants/view') }}">
              All Applicants(name /Company/ID/department)
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('all/new-applicants/view') ? 'active-submenu' : '' }}" href="{{ url('/all/new-applicants/view') }}">
              All new applicants
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('all/applicants-without_id/view') ? 'active-submenu' : '' }}" href="{{ url('/all/applicants-without_id/view') }}">
              Applicants Without ID's
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('all/user-lst_login_logout/view') ? 'active-submenu' : '' }}" href="{{ url('/all/user-lst_login_logout/view') }}">
              Applicants Last Login's
            </a>
          </li>
          <li class="nav-item">
            <a
              class="nav-link {{ request()->is('inactive/employees/view') ? 'active-submenu' : '' }}" href="{{ url('/inactive/employees/view') }}">
              Inactive employees
            </a>
          </li>
          <li class="nav-item">
    ...
    @php 
      ...
      request()->is('approve/vaccation/hours'); $holidayActive = request()->routeIs('holidays.*'); 
      $companyActive = request()->routeIs('companies.*'); 
    @endphp 
    ...
    @php
      $userActive =
      (request()->routeIs('users.create') && !request('u')) ||
      (request()->routeIs('users.edit') && request('u') == 'user') ||
      request()->routeIs('users.index') ||
      request()->is('timesheetapproval') ||
      request()->is('user/create/timesheets/*') ||
      (
        request()->is('user/changepassword/*') &&
        !in_array(request('u'), ['supervisor', 'casemanager'])
      ) ||
      (
        request()->is('user/timesheets/*') &&
        !in_array(request('u'), ['supervisor', 'casemanager'])
      ) ||
      (
        request()->is('user/driver/license/*') &&
        !in_array(request('u'), ['supervisor', 'casemanager'])
      ) ||
      (
        request()->is('user/edit/timesheets/*') &&
        !in_array(request('u'), ['supervisor', 'casemanager'])
      );
    @endphp
    <li class="nav-item {{ $userActive ? 'active' : '' }}">
      ...
      <div class="collapse {{ $userActive ? 'show' : '' }}" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link {{
              request()->routeIs('users.create') && !request('u')
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->is('timesheetapproval') ? 'active-submenu' : '' }}"
              href="{{ URL('/timesheetapproval') }}">
              Timesheet Approval
            </a>
          </li>
        </ul>
    ...
    <?php if(Auth::user()->admin_permissions == null && Auth::user()->admin_permissions != 1 ){ ?>
    <li class="nav-item {{   
        (request()->routeIs('users.create') && request('u') == 'casemanager') ||   
        (request()->routeIs('users.edit') && request('u') == 'casemanager') ||
        (request()->is('user/changepassword/*') && request('u') == 'casemanager') ||
        request()->routeIs('casemanagers.index')   
        ? 'active' : ''   
      }}">     
      <a     
        class="nav-link"     
      ...
      <div class="collapse {{   
        ...
        <ul class="nav flex-column sub-menu">     
          <li class="nav-item">     
            ...
            href="{{ route('users.create', ['u' => 'casemanager']) }}">    
              Add Case Manager    
            </a>     
          </li>     
          <li class="nav-item">     
    ...
    <li class="nav-item {{  
        (
          (request()->routeIs('users.create') && request('u') == 'supervisor') ||  
          (request()->routeIs('users.edit') && request('u') == 'supervisor') ||  
          request()->routeIs('supervisors.index') ||
          (request()->is('user/changepassword/*') && request('u') == 'supervisor') ||
          (request()->is('user/suser/*') && request('u') == 'supervisor')
        ) ? 'active' : ''  
      }}">
      <a class="nav-link"
        data-toggle="collapse"
      ...
      <div class="collapse {{
        ...
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            ...
            href="{{ route('users.create', ['u' => 'supervisor']) }}">
              Add Supervisor
            </a>
          </li>
          <li class="nav-item">
    ...
    @php
    $notificationActive =
      request()->routeIs('notifications.create') ||
      request()->routeIs('notifications.index') ||
      request()->is('notifications/*/edit');
    @endphp
    <li class="nav-item {{ $notificationActive ? 'active' : '' }}">
      <a 
        class="nav-link" 
        data-toggle="collapse" 
        href="#ui-notifcation" 
        aria-expanded="{{ $notificationActive ? 'true' : 'false' }}" 
        aria-controls="ui-notifcation"
        >
        <i class="menu-icon typcn typcn-coffee"></i>
          <span class="menu-title">
      ...
      <div class="collapse {{ $notificationActive ? 'show' : '' }}" id="ui-notifcation">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
              <a 
                class="nav-link {{ request()->routeIs('notifications.create') ? 'active-submenu' : '' }}" 
          ...
          <li class="nav-item">
            <a 
              class="nav-link {{ request()->routeIs('notifications.index') || request()->is('notifications/*/edit') ? 'active-submenu' : '' }}" 
    ...
    <li class="nav-item {{ request()->is('lists-issue*') ? 'active' : '' }}"> 
