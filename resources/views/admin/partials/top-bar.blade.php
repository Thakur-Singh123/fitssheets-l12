		...
		<div class="main-search" style="width: 52%;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <p class="font-weight-light text-muted mb-0">{{ Auth::user()->email }}</p>
                ...
                <a href="{{ url('/admin/edit-profile') }}" class="dropdown-item">Edit Profile<span class="badge badge-pill badge-danger"></span><i class="dropdown-item-icon ti-dashboard"></i></a>
				<?php if(Auth::user()->id == 72 || Auth::user()->id == 50 ){ ?>
			<?php }else{ ?>
				<a href="{{ url('/admin/change-password') }}" class="dropdown-item">Change Password<i class="dropdown-item-icon ti-power-off"></i></a>
				<?php } ?>
