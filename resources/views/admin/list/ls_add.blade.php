    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            ...
            <form id="time_sheet" method="POST" action="{{ url('/lists-issue/store') }}" class="forms-sample">
            @csrf
            ...
            */?>
            <div class="form-group">
                ...
                <input
                  ...
                  value="{{ old('resolution_remarks') }}"
                  placeholder="Enter any resolution remarks"
                />
            </div>
