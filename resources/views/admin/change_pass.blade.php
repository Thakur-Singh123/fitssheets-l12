    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="{{ url('/admin/updatepassword') }}" class="forms-sample">
            @csrf
            <div class="form-group">
              <label for="password" >Current Password</label>
              <div style="position:relative;">
                <input id="password" placeholder="Enter current password" type="password" class="form-control" name="current_password" value="{{ old('current_password')}}">
